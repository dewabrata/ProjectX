...
public class AdapterGridSingleLineVendorChild extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterGridSingleLineVendorChild(Context context, List<Merchandise> items) {
        this.items = items;
        ctx = context;
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_grid_image_single_line_vendor, parent, false);
